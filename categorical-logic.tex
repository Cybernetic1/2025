...
Lambek (guy \#24) discovered the link between \textbf{higher-order logic} (HOL) and \textbf{Cartesian-Closed Categories} (CCCs), which I find very useful.  This is a form of ``untyped'' logic which suffers ffrom Curry's paradox (guy \#5) but which I think can be circumvented by fuzzy logic.  Bertrand Russell and Alfred North Whitehead invented \textbf{type theory} to get around Curry's paradox, but I personally prefer untyped logic.
